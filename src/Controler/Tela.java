...
public class Tela extends javax.swing.JFrame implements MouseListener, KeyListener {
 ...
 /*Cria a janela do tamanho do tabuleiro + insets (bordas) da janela*/
    ...
    // Carrega a fase 1
    Modelo.Fase1 fase1 = new Modelo.Fase1();

    // Encontra o Hero e conecta à variável da tela
...
this.go(); // inicia o timer de atualização do jogo
    }

    public void setHero(Hero hero) {
    this.hero = hero;
    this.atualizaCamera(); //já atualiza a câmera assim que o hero for setado
}
    private int contarChips() {
    int cont = 0;
    for (Personagem p : faseAtual) {
        if (p instanceof ChipColetavel) {
            cont++;
        }
    }
    return cont;
    ...
    public void paint(Graphics gOld) {
        ...
        g2.fillRect(0, 0, getWidth(), 30); // fundo da HUD

        g2.setColor(new java.awt.Color(255, 255, 0)); // amarelo retro
